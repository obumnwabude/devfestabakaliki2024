    ...
    <>
      ...
      >
        <Container>
          ...
          <div className="flex w-full mt-10 flex-col-reverse md:flex-row gap-8">
            <div className="basis-1/2">
              <form action="" method="get" className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <div className="grid gap-x-6 gap-y-6 md:grid-cols-2 outline-none">
                      <label
                        htmlFor="pro"
            ...
            <aside
              ...
              className="opacity-1 relative flex items-center basis-1/2"
            >
